...
- send interval は W08 baseline `rate_hz=100` と `rate_hz=10000` を比較する。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| send interval | baseline rate_hz=100 | rate_hz=10000 | 0.019583 | 0.014197 | 0.036339 | 0.014994 | -58.74% | 0.00000000 | 0.00000000 | 100Hz baselineから10,000Hzへ上げてもmissingは0。p99は大きく悪化せず、Raspberry Pi 5の余裕が大きい。 |
